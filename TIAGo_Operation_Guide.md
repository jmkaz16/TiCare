...
*   **Booting:** Wait a few seconds for the robot to "wake up" (motor initialization). Keep a safe distance during this process.
...
4. **Modules:** Use the right-side panel to launch complex modules such as SLAM (mapping) or Navigation.
