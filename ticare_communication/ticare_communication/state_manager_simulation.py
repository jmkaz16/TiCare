...
def record_audio():
    ...
    """
    process = subprocess.Popen(["ros2", "run", "ticare_communication", "save_audio_simulation"])
    process.wait()
...
def transcribe_audio(
    ...
    Args:
        ruta_wav (str): Path to the WAV file.

    Returns:
        str: Transcribed text or "Errr" if recognition fails.
    """
